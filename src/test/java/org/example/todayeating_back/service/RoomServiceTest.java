...
class RoomServiceTest {
    ...
    void 회원생성_및_방생성() {
        ...
        // 회원가입
        memberInfo = memberService.saveMember(email, password);

        String roomName = "roomNameTest";
        String roomPassword = "1234";
        RoomRequest roomRequest = new RoomRequest(roomName, roomPassword);

        String roomNameTwo = "roonNameTest";
        RoomRequest roomRequest2 = new RoomRequest(roomNameTwo, roomPassword);
